...
// include: /home/runner/work/rbfx/rbfx/rbfx-build/web-emscripten-wasm-lib/Source/Samples/SampleResources.js.load.js
if (!ENVIRONMENT_IS_WORKER) {
  Module["preRun"].push(function() {
    Module["addRunDependency"]("SampleResources.js.loader");
    var s = document.createElement("script");
    s.src = "SampleResources.js";
    document.body.appendChild(s);
    s.onload = function() {
      Module["removeRunDependency"]("SampleResources.js.loader");
    };
  });
}

// end include: /home/runner/work/rbfx/rbfx/rbfx-build/web-emscripten-wasm-lib/Source/Samples/SampleResources.js.load.js
var programArgs = [];
  ...
  xhr.onprogress = e => {
    ...
    for (var bytePos = 0; bytePos < ptrLen || !ptrLen; ) {
      ...
      if (sz > 0 && fetchAttrLoadToMemory && fetchAttrStreamData) {
        ...
        // The data pointer malloc()ed here has the same lifetime as the emscripten_fetch_t structure itself has, and is
        // freed when emscripten_fetch_close() is called.
        ptr = _realloc((growMemViews(), HEAPU32)[(((fetch) + (12)) >> 2)], sz);
        (growMemViews(), HEAPU8).set(new Uint8Array(/** @type{Array<number>} */ (xhr.response), bytePos, sz), ptr);
      }
      (growMemViews(), HEAPU32)[(((fetch) + (12)) >> 2)] = ptr;
...
var ASM_CONSTS = {
  ...
  1957150: () => window.innerWidth,
  1957180: () => window.innerHeight,
  1957211: $0 => {
    try {
